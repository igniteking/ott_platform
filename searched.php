        ...
        <div class="row flexbox-center">
            <div class="col-lg-6 text-center text-lg-left">
                <div class="section-title">
                    <h1><i class="icofont icofont-search"></i> Searched Results</h1>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="video-slider mt-20">
                    ...
                    $searched = file_get_contents("https://api.themoviedb.org/3/discover/movie?with_networks=$network&api_key=$api_key&language=$language&page=3");
                    $searched = json_decode($searched, true);
